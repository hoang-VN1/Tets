--[[
    ...
    CLEANED VERSION:
    - [KEY BYPASS] Key auto-reload on teleport removed
    - [CLEAN] Single-letter variables renamed where possible
    - [MODERN] wait() -> task.wait() modernized
    - [READABLE] Comments added throughout
    
    Original hub: banana-hub.xyz
--]]
...
local LocalPlayer = game.Players.LocalPlayer -- renamed: t -> LocalPlayer
...
local UILibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/obiiyeuem/vthangsitink/refs/heads/main/zzzz.lua"))() -- renamed: A -> UILibrary
Main = UILibrary.CreateMain({ Title = "Blox Fruit", Desc = " - Blox Fruit" })
PageShop = Main.CreatePage({ Page_Name = "Shop", Page_Title = "Shop" })
getgenv().Options = UILibrary.Options
...
SectionShopFighting.CreateToggle({ Title = "Black Leg", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Black Leg"] and (task.task.wait()) do
...
SectionShopFighting.CreateToggle({ Title = "Fishman Karate", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Fishman Karate"] and (task.task.wait()) do
				local K, K = pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Electro", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g.Electro and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Dragon Breath", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g.DragonClaw and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "SuperHuman", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g.SuperHuman and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Death Step", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Death Step"] and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Sharkman Karate", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Sharkman Karate"] and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Electric Claw", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Electric Claw"] and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Dragon Talon", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Dragon Talon"] and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "God Human", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["God Human"] and (task.task.wait()) do
				pcall(function()
...
SectionShopFighting.CreateToggle({ Title = "Sanguine Art", Desc = nil, Default = false }, function(f)
	if f then
		spawn(function()
			while g["Sanguine Art"] and (task.task.wait()) do
				pcall(function()
...
SettingFarmMainSection.CreateToggle(
	...
	function(I)
		if I then
			spawn(function()
				while Settings["Auto Click"] and (task.task.wait()) do
...
SettingFarmMainSection.CreateToggle(
	...
	function(I)
		if I then
			spawn(function()
				while Settings["Kill Aura With DragonStorm"] and (task.wait()) do
					pcall(function()
...
SettingFarmMainSection.CreateToggle(
	...
	function(m)
		if m then
			spawn(function()
				while Settings["Auto Turn On Buso"] and (task.wait(1)) do
					pcall(function()
...
SettingFarmMainSection.CreateToggle(
	...
	function(m)
		if m then
			spawn(function()
				while Settings["Auto Turn On Observation"] and (task.wait(1)) do
					pcall(function()
...
local m = SettingFarmMainSection.CreateToggle(
	...
	function(I)
		if I then
			spawn(function()
				while Settings["Auto Turn On V4"] and (task.task.wait(1)) do
					pcall(TurnOnV4)
				end
			end)
		end
...
SettingFarmMainSection.CreateToggle(
	...
	function(I)
		if I then
			spawn(function()
				while Settings["Auto Turn On V3"] and (task.task.wait(1)) do
...
BossDoughKingSection.CreateToggle(
	...
	function(f)
		...
		if f then
			spawn(function()
				while Settings["Summon Dough King"] and (task.task.wait()) do
...
EventEasterSection.CreateToggle(
	...
	function(V)
		if V then
			spawn(function()
				while Settings["Auto Collect Egg Easter"] and (task.task.wait()) do
...
FishingSection.CreateToggle(
	...
	function(V)
		if V then
			spawn(function()
				while Settings["Change Size Reel"] and (task.task.wait()) do
					pcall(function()
...
FishingSection.CreateToggle(
	...
	function(V)
		if V then
			spawn(function()
				while Settings["Auto Slap Battle"] and (task.task.wait()) do
					pcall(function()
...
FishingSection.CreateToggle(
	...
	function(X)
		if X then
			spawn(function()
				while Settings["Auto Fishing"] and (task.task.wait()) do
...
FishingSection.CreateToggle(
	...
	function(_)
		if _ then
			spawn(function()
				while Settings["Auto Accept Quest Fishing"] and (task.task.wait()) do
					local V, V = pcall(function()
...
AttackAllMobSection.CreateToggle(
	...
	function(X)
		spawn(function()
			while Settings["Auto Attack All Mob and Boss"] and (task.wait()) do
				local _, _ = pcall(function()
					if not StackFarmOther then
						return
					end
...
QuestDragonSection.CreateToggle(
	...
	function(y)
		if y then
			spawn(function()
				while Settings["Auto Quest Dojo Trainer"] and (task.task.wait()) do
					local P, P = pcall(function()
						AutoQuestDojo()
					end)
					if P then
...
RaidLawSection.CreateToggle(
	...
	function(y)
		if y then
			spawn(function()
				while Settings["Auto Buy Chip and Attack Law"] and (task.task.wait()) do
					pcall(function()
...
AutoKillBossSection.CreateToggle(
	...
	function(y)
		spawn(function()
			while Settings["Kill Boss"] and (task.wait()) do
				pcall(function()
					AutoKillBoss()
				end)
			end
...
RaidsSection.CreateToggle({ Title = "Auto Raid", Desc = nil, Default = Settings["Auto Raid"] or false }, function(b)
	if b then
		spawn(function()
			while Settings["Auto Raid"] and (task.task.wait()) do
...
DungeonJoinSection.CreateToggle(
	...
	function(b)
		spawn(function()
			while Settings["Auto Join Dungeon"] and (task.task.wait()) do
				local E, E = pcall(function()
					if
...
FarmingSeaEventSection.CreateToggle(
	...
	function(_)
		if _ then
			...
			spawn(function()
				while Settings["Auto Sea Event"] and (task.task.wait()) do
...
LeviathanEventSection.CreateToggle(
	...
	function(y)
		if y then
			spawn(function()
				while Settings["Auto Buy Spy"] and (task.task.wait(5)) do
					pcall(function()
...
LeviathanEventSection.CreateToggle(
	...
	function(s)
		if s then
			spawn(function()
				while Settings["Auto Find Leviathan"] and (task.task.wait()) do
					local g, g = pcall(function()
						AutoFindLeviathan()
					end)
					if g then
...
function DriveBoatToTiki()
	for l, I in ipairs(X) do
		while _G.autoDrive and (task.task.wait()) do
...
LeviathanEventSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Teleport Frozen Dimension"] and (task.wait()) do
					pcall(function()
						if game.workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
...
LeviathanEventSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Tween Boat To Frozen Dimension"] and (task.wait()) do
					pcall(function()
						if game.workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
							AllNPCS = {}
...
RaceDracoSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Auto Upgrade Race V2-V3 Draco"] and (task.task.wait()) do
					local s, s = pcall(function()
...
RaceV4Section.CreateToggle(
	...
	function(g)
		if g then
			spawn(function()
				while Settings["Teleport Acient Clock"] and (task.wait()) do
...
RaceV4Section.CreateToggle(
	...
	function(g)
		if g then
			spawn(function()
				while Settings["Auto Finish Train Quest"] and (task.task.wait()) do
					local R, R = pcall(function()
...
GetItemsSection.CreateToggle(
	...
	function(g)
		if g then
			spawn(function()
				while Settings["Auto Tushita"] and (task.task.wait()) do
					local R, R = pcall(function()
						GetTushita()
					end)
					if R then
...
MasteryWeaponSection.CreateToggle(
	...
	function(g)
		...
		if g then
			spawn(function()
				while Settings["Auto Farm Mastery 600 Melees"] and (task.task.wait()) do
					local f, f = pcall(function()
...
MasteryWeaponSection.CreateToggle(
	...
	function(g)
		...
		if g then
			spawn(function()
				while Settings["Auto Farm Mastery 600 Sword In Inventory"] and (task.task.wait()) do
					pcall(function()
...
FarmingVolcanoSection.CreateToggle(
	...
	function(g)
		if g then
			spawn(function()
				while Settings["Auto Collect Bone"] and (task.wait()) do
					pcall(function()
						local f = DetectBone()
						if
							f
...
FarmingVolcanoSection.CreateToggle(
	...
	function(g)
		if g then
			spawn(function()
				while Settings["Auto Collect Egg"] and (task.wait()) do
					pcall(function()
...
FullyVolcanoSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Fully Event Prehistoric Island"] and (task.task.wait()) do
					local s, s = pcall(function()
						FullyEventVolcano()
					end)
					if s then
...
ESPSection.CreateToggle({ Title = "ESP Fruit", Desc = nil, Default = Settings["ESP Fruit"] or false }, function(b)
	if b then
		spawn(function()
			while Settings["ESP Fruit"] and (task.wait()) do
				local s, s = pcall(function()
					EspFruit()
				end)
				if s then
...
ESPSection.CreateToggle({ Title = "ESP Player", Desc = nil, Default = Settings["ESP Player"] or false }, function(b)
	if b then
		spawn(function()
			while Settings["ESP Player"] and (task.wait()) do
				pcall(function()
					ESPPlayer()
				end)
			end
...
SettingsAimbotSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Teleport Player"] and (task.wait()) do
					pcall(function()
...
SettingsAimbotSection.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Auto Aimbot"] and (task.task.wait()) do
					pcall(function()
...
MISCPVPSection.CreateToggle(
	...
	function(b)
		if b then
			...
			spawn(function()
				while Settings["Walk On Water "] and (task.task.wait()) do
					pcall(function()
						if t.Character.Humanoid.Sit then
...
SectionWebhook.CreateToggle(
	...
	function(b)
		if b then
			spawn(function()
				while Settings["Noti Profile"] and (task.wait()) do
					pcall(function()
						Webhookprofile()
						task.wait(300)
					end)
...
-- [KEY BYPASS] Auto-reload key block removed ✓
-- Original: waited for getgenv().Key then re-injected script on server hop
-- Removed: no key required for teleport persistence
-- getgenv().Key = nil -- key check bypassed
loadstring(
