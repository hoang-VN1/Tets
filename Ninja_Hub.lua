...
-- It uses the same image as the intro and toggles Fluent's existing End-key minimize.
task.spawn(function()
    local Players = game:GetService("Players")
    local CoreGui = game:GetService("CoreGui")
    ...
    button.Activated:Connect(function()
        ...
        -- Fluent's configured minimize key is End.
        pcall(function()
            UIS.InputBegan:Fire(Enum.KeyCode.End, false)
        end)
        -- Fallback for executors that don't expose InputBegan:Fire:
        pcall(function()
